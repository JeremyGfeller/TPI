<?php
    ...
    $query = "SELECT name, typeWine, year, id_vintage FROM wine INNER JOIN vintage on id_wine = fk_wine INNER JOIN typeWine on fk_typeWine = id_typeWine;";
    ...
    foreach($allWines as $allWine)
    {
        ...
        $res = array('name' => $name , 'typeWine' => $typeWine, 'year' => $year);
